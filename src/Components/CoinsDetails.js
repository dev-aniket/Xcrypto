...
// import ErrorCompnent from './ErrorComponent';
...
const CoinsDetails = () => {
  ...
  const btns = ["24h", "7d", "14d", "30d", "60d", "max"];
      ...
      <HStack p="4" overflowX={"auto"}>
        ...
        <RadioGroup value={currency} onChange={setCurrency} p={"4"} >
         ...
         <VStack spacing={"4"} p={"16"} alignItems={"flex-start"}>
          <Text fontSize={"small"} alignSelf={"center"} opacity={"1"}> 
          Last Updated On{" "} 
          ...
          src={coin.image.large}
           ...
           <Stat>
            ...
            <StatHelpText>
              <StatArrow tyoe = {(coin.market_data.price_change_percentage_24h > 0) ? "increase" : "decrease"}/>
